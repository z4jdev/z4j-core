...
class Schedule(Z4JModel):
    ...
    Attributes:
        ...
        source_hash: Content hash of (name, kind, expression, timezone,
                     task_name, args, kwargs) used by importers and
                     declarative reconcilers for re-import idempotency.
...
__all__ = ["CatchUpPolicy", "Schedule", "ScheduleKind"]
